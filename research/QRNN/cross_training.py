...
if __name__=="__main__":
    ...
    for q in q_set:
        cross_training(qnn, pipeline_small_exclude, 1, q=q, layers=1, neurons = 32,
                       dropout=0.05, noise_in=0.0, noise_out=0.,
                       ...
                       verbose=0, name="qnn_ex_pca_tanh", activation="tanh")