...
def plot_timeseries(lead, ax):
    ...
    for quantile in list(data.keys()):
...
nll_esitmate = evaluation_nll(f'{model_name}', std_name='std_estimate',
                              filename=f'{model_name}_forecasts_with_std_estimated.nc')
